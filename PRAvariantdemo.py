...
from PRAvarianttests import experiments,comparePRA,comparison
...
compcount,compmeans,normavg,minevavg,compresults,normresults,minevresults = comparison(rset,n,deltaset,N)
